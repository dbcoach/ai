                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <div className={`absolute inset-0 rounded-xl transition-opacity duration-500 ${
                      ...
                      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500 via-blue-500 via-green-500 via-yellow-500 via-red-500 to-white-500 animate-flowing-border p-0.75">
